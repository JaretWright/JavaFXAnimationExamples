...
// Keyboard events
public class BullseyeClicker extends Application
{
    ...
    public void start(Stage theStage)
    {
        ...
        theScene.setOnMouseClicked(
                new EventHandler<MouseEvent>()
                {
                    ...
                    {
                        //if the user hits the target, reposition the target
                        //and increase the points
                        if ( targetData.containsPoint( event.getX(), event.getY() ) )
                        {
                            ...
                            //if the user misses the target, reset the points
                            points.value = 0;
                    }
                });
