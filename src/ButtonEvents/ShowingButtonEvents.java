...
public class ShowingButtonEvents extends Application
{
    ...
    private static void loadGraphics()
    {
        ...
        leftGreen = new Image("Images/leftG.png");

        right = new Image("Images/right.png");
        rightGreen = new Image("Images/rightG.png");
    }
